...
Object.defineProperty(exports, "__esModule", { value: true });
const core = __importStar(__webpack_require__(470));
const spawn_1 = __webpack_require__(311);
const fs_1 = __webpack_require__(747);
const { mkdir } = fs_1.promises;
function clone({ repoUrl, dir, branch, debug, }) {
    return __awaiter(this, void 0, void 0, function* () {
        const dbg = (debug !== null && debug !== void 0 ? debug : core.debug);
        dbg(`Cloning repo into dir(${dir})`);
        yield spawn_1.spawn('git', 'clone', '--single-branch', '--branch', branch, '--', repoUrl, dir).catch(() => __awaiter(this, void 0, void 0, function* () {
            dbg(`Branch ${branch} missing. Creating an orphan`);
            yield mkdir(dir, { recursive: true });
            yield spawn_1.spawn('git', { cwd: dir }, 'init');
            yield spawn_1.spawn('git', { cwd: dir }, 'remote', 'add', 'origin', repoUrl);
            yield spawn_1.spawn('git', { cwd: dir }, 'checkout', '--orphan', branch);
        }));
...
const clone_1 = __webpack_require__(335);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { branch, repo: repoUrl, dir } = readInputs_1.readInputs();
            const debug = console.log.bind(0);
            yield clone_1.clone({ branch, repoUrl, dir, debug });
            core.debug(`Cloned`);
        }
        catch (error) {
